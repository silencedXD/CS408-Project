...
RLevelSelectHandler::RLevelSelectHandler(GraphicsUnit* graphics_, ObjectFactory* oFactory_, AudioUnit* audio_) : InputHandler(graphics_, oFactory_, audio_) {
...
MenuCode RLevelSelectHandler::updateState(sf::Time elapsed) {
    updateArrow();
...
void RLevelSelectHandler::playTextPrompt() {
    switch (selector) {
    case 0:
